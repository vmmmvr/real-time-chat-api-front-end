...
import { createChannelsThunk } from '../../redux/channel/channel.thunk';
    ...
    <form className=" md:p-0 p-4 w-full flex flex-col" onSubmit={handleSubmit((data) => {
        ...
        dispatch(createChannelsThunk({input: {
            ...
            <div className="flex flex-col mb-5">
              <label className="text-gray-500 mb-1" htmlFor="name">Channel Name</label>
      ...
      >
        ...
        />
            ...
            <button className="bg-primary px-5 py-2 text-white text-sm rounded-md" type="submit">Create A Channel</button>
          </form>
            </div>
